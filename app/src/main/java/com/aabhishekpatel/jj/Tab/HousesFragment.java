...
public class HousesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progress_bar.setIndeterminateDrawable(FadingCircle);
        ...
        /*----------- Houses_Model -----------*/
        housesModelList = new ArrayList<HousesModel>();
        ...
        /*-------------------------- Load houses data to recycleview -------------------------------*/
        reference = FirebaseDatabase.getInstance().getReference().child("Houses");
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    HousesModel housesModel = dataSnapshot1.getValue(HousesModel.class);
                    housesModelList.add(housesModel);
                }
                housesAdapter = new HousesAdapter(getContext(), housesModelList);
